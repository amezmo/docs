...
Switching [PHP versions](../php/index.md), or upgrading to a new version can be done without launching a new instance. Although you may switch
...
6. At the top right, click the more options menu (**⋯**), then **Change PHP version**
7. Choose a PHP version
8. Click "Change PHP version"

![Change PHP version dialog with the PHP version selector](https://s3.us-east-2.amazonaws.com/static.amezmo.net/change-php-version.png){.img-enlargable}

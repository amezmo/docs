...
Change the version from the Overview tab, under Application settings. See
[Changing PHP versions](../how-to-guides/changing-php-versions.md) for the full
steps.

> [!WARNING]
> Changing the PHP version restarts the instance, so expect a brief moment of
> downtime.

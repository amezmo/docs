...
an [automated deployment](../deployments/index.md).
...
automatic deployments are started when commits are made to the [automatic deployment branch](branches.md), or when a tag is created and one of your
 [tag-based deployment](tag-based-deployments.md) patterns is matched against the tag.

...
<img src="/assets/SSHKeyList.png" class="img-enlargable" alt="Instance Overview tab showing the SSH access toggle and the list of added public keys" />
...
<img src="/assets/SSHKeyForm.png" class="img-enlargable" alt="Add public key modal with fields for a key name and the public key text" />
